<?php
/**
 * de_de language for the froxlor module
 */
// Basics
...
$lang['Froxlor.manage.module_rows.confirm_delete'] = 'Sind Sie sich sicher, dass Sie diesen Server löschen wollen?';
$lang['Froxlor.manage.module_groups.confirm_delete'] = 'Sind Sie sich sicher, dass Sie diese Server Gruppe löschen wollen?';
...
$lang['Froxlor.row_meta.otl_time_limit'] = 'Gültigkeitsdauer des Direktlogin-Links (in Sekunden)';
...
$lang['Froxlor.package_fields.tooltip.domains_list'] = 'Geben Sie eine Liste von Domain-Namen ein, die zur Erstellung von Sub-Domains verwendet werden dürfen. z.B. "domain1.de,domain2.de,domain3.de"';
...
// Tooltips
$lang['Froxlor.service_field.tooltip.username'] = 'Sie können das Feld für den Benutzernamen leer lassen um automatisch einen zu generieren.';
$lang['Froxlor.service_field.tooltip.password'] = 'Sie können das Feld für das Passwort leer lassen um automatisch eins zu generieren.';


// Errors
$lang['Froxlor.!error.server_name_valid'] = 'Sie müssen einen Servernamen angeben.';
...
$lang['Froxlor.!error.api_secret_valid_connection'] = 'Es konnte keine Verbindung zum Server hergestellt werden. Bitte prüfen Sie, dass der Hostname, API Key und API Secret richtig sind.';
...
$lang['Froxlor.!error.froxlor_sub_domain.availability'] = 'Diese Sub-Domaine ist leider nicht mehr verfügbar. Bitte wählen Sie eine andere.';
